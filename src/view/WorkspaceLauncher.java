...
public class WorkspaceLauncher extends JDialog {
	...
	public WorkspaceLauncher(AppModel model, MenuBar mb) {
		...
		if (currentWorkspace == null || currentWorkspace.isEmpty()) {
			currentWorkspace = System.getProperty("user.home") + File.separator + "Evermode" + File.separator
					+ "Default Workspace";
		}
	...
	private void init() {
		...
		JLabel text = new JLabel(
				"<html><b>Izaberize Workspace</b><br/><br/>&nbsp&nbsp&nbsp Evermode smješta vaše projekte u folder zvani Workspace."
